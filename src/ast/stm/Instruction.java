...
{ /* This is just a opspace. YKG */

  /*
   * //insn_format41c_type:INSTRUCTION_FORMAT41c_TYPE REGISTER
   * reference_type_descriptor //e.g. const-class/jumbo v2,
   * org/jf/HelloWorld2/HelloWorld2 public static class F41c_type extends T {
   * public String name; public String reg; public String ref;
   * 
   * @Override public void accept(Visitor v) { v.visit(this); } }
   * 
   * //insn_format41c_field:INSTRUCTION_FORMAT41c_FIELD REGISTER
   * fully_qualified_field //e.g. sget-object/jumbo v0,
   * Ljava/lang/System;->out:LJava/io/PrintStream; public static class
   * F41c_field extends T { public String name; public String reg; public
   * ast.classs.FieldItem fieldItem;
   * 
   * @Override public void accept(Visitor v) { v.visit(this); } }
   * 
   * //insn_format52c_field:INSTRUCTION_FORMAT52c_FIELD REGISTER REGISTER
   * fully_qualified_field //e.g. iput-object/jumbo v1, v0,
   * Lorg/jf/HelloWorld2/HelloWorld2;->helloWorld:Ljava/lang/String; public
   * static class F52c_field extends T { public String name; public String rega;
   * public String regb; public ast.classs.FieldItem fieldItem;
   * 
   * @Override public void accept(Visitor v) { v.visit(this); } }
   * 
   * 
   * //insn_format5rc_method: INSTRUCTION_FORMAT5rc_METHOD register_range
   * fully_qualified_method //e.g. invoke-virtual/jumbo {}
   * java/lang/StringBuilder/append(Ljava/lang/String;) public static class
   * F5rc_method extends T { public String name; public String startReg; public
   * String endReg; public ast.classs.MethodItem methodItem ;
   * 
   * @Override public void accept(Visitor v) { v.visit(this); } }
   * 
   * //insn_format5rc_type:INSTRUCTION_FORMAT5rc_TYPE register_range
   * nonvoid_type_descriptor //e.g. filled-new-array/jumbo {} I public static
   * class F5rc_type extends T { public String name; public String startReg;
   * public String endReg; public String type;
   * 
   * @Override public void accept(Visitor v) { v.visit(this); } }
   * 
   * //insn_array_data_directive:^(I_ARRAY_ELEMENT_SIZE short_integral_literal)
   * array_elements //e.g. .array-data 4 1000000 .end array-data public static
   * class Array_data_dir extends T { public String name; public String value;
  ...
  // (INSTRUCTION_FORMAT21c_FIELD | INSTRUCTION_FORMAT21c_FIELD_ODEX) REGISTER
  ...
  // e.g. iput-object v1, v0, org/jf/HelloWorld2/HelloWorld2.helloWorld
  // Ljava/lang/String;
  ...
  public static class IgetWide extends T
  {
    ...
    public IgetWide(String op, String dest, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
      this.dest = dest;
  ...
  public static class IgetOjbect extends T
  {
    ...
    public IgetOjbect(String op, String dest, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IgetBoolean extends T
  {
    ...
    public IgetBoolean(String op, String dest, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IgetByte extends T
  {
    ...
    public IgetByte(String op, String dest, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IgetChar extends T
  {
    ...
    public IgetChar(String op, String dest, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IgetShort extends T
  {
    ...
    public IgetShort(String op, String dest, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IputWide extends T
  {
    ...
    public IputWide(String op, String src, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IputObject extends T
  {
    ...
    public IputObject(String op, String src, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IputBoolean extends T
  {
    ...
    public IputBoolean(String op, String src, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IputByte extends T
  {
    ...
    public IputByte(String op, String src, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IputChar extends T
  {
    ...
    public IputChar(String op, String src, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  public static class IputShort extends T
  {
    ...
    public IputShort(String op, String src, String field,
        ast.classs.FieldItem type)
    {
      super();
      this.op = op;
  ...
  // insn_format22s:INSTRUCTION_FORMAT22s registerA=REGISTER registerB=REGISTER
  ...
  public static class CmplDouble extends T
  {
    ...
    public CmplDouble(String op, String dest, String first, String second)
    {
      super();
      this.op = op;
      this.dest = dest;
  ...
  public static class Cmpgdouble extends T
  {
    ...
    public Cmpgdouble(String op, String dest, String first, String second)
    {
      super();
      this.op = op;
      this.dest = dest;
  ...
  public static class AgetBoolean extends T
  {
    ...
    public AgetBoolean(String op, String dest, String array, String index)
    {
      super();
      this.op = op;
      this.dest = dest;
  ...
  // (with supplemental data as specified below in
  ...
  // s(with supplemental data as specified below in
  ...
  // insn_format35c_method:INSTRUCTION_FORMAT35c_METHOD register_list
  // fully_qualified_method
  // e.g. invoke-virtual {} java/io/PrintStream/print(Ljava/lang/Stream;)V

  // insn_format35c_type:INSTRUCTION_FORMAT35c_TYPE register_list
  ...
  public static class InvokeVirtual extends T
  {
    ...
    public InvokeVirtual(String op, List<String> argList, MethodItem type)
    {
      super();
      this.op = op;
      this.argList = argList;
  ...
  public static class InvokeSuper extends T
  {
    ...
    public InvokeSuper(String op, List<String> argList, MethodItem type)
    {
      super();
      this.op = op;
      this.argList = argList;
  ...
  public static class InvokeDirect extends T
  {
    ...
    public InvokeDirect(String op, List<String> argList, MethodItem type)
    {
      super();
      this.op = op;
      this.argList = argList;
  ...
  public static class InvokeStatic extends T
  {
    ...
    public InvokeStatic(String op, List<String> argList, MethodItem type)
    {
      super();
      this.op = op;
      this.argList = argList;
  ...
  public static class InvokeInterface extends T
  {
    ...
    public InvokeInterface(String op, List<String> argList, MethodItem type)
    {
      super();
      this.op = op;
      this.argList = argList;
  ...
  // insn_format3rc_method:INSTRUCTION_FORMAT3rc_METHOD register_range
  // fully_qualified_method
  // e.g. invoke-virtual/range {}
  // java/lang/StringBuilder/append(Ljava/lang/String;)

  // insn_format3rc_type:INSTRUCTION_FORMAT3rc_TYPE register_range
  // nonvoid_type_descriptor
